...
def post_change_password(data_variables):
    print("post_change_password")
    ...
    NOTEBOOK_PATH = f'{BASE_NOTEBOOK_PATH}/proc_change_password'
    ...
    payload = {
        ...
        "notebook_task": {
            ...
            "base_parameters": {
                ...
                "current_password": data_dict['current_password'],
