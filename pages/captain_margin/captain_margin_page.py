...
def get_layout(pathname, user_data):
    ...
    container_change_approval = container_approval_reject_buttons(table="captain-margin")
    ...
    toast_approval = Toast(
        id="toast-approval-captain-margin",
        header=_("Aprovação"),
        toast_message=_("Enviado para aprovação"),
    )

    toast_reject = Toast(
        id="toast-approval-reject-captain-margin",
    )
    container_table = html.Div(
        table,
        style=CONTAINER_TABLE_STYLE
...
modal_confirm_approval = create_modal(
    modal_id="modal-confirm-approval-captain-margin",
...
@callback(
    Output("modal-confirm-approval-captain-margin", "is_open"),
...
@callback(
    Output("modal-confirm-approval-captain-margin", "is_open", allow_duplicate=True),
    Output("toast-approval-captain-margin", "is_open", allow_duplicate=True),
...
@callback(
    Output("toast-approval-reject-captain-margin", "is_open"),
    Output("toast-approval-reject-captain-margin", "header"),
    Output("toast-approval-reject-captain-margin", "children"),
